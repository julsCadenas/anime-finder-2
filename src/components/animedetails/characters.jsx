                    ...
                    <>
                        <label className="inline-flex items-center cursor-pointer md:mb-4">
                            ...
                            <div className="relative w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700
                                            ...
                                            rtl:peer-checked:after:-translate-x-full peer-checked:after:border-gray-300 after:content-[''] after:absolute after:top-[2px] after:start-[2px]
                                            after:bg-gray-300 after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-gray-500"></div>
